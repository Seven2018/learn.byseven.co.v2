...
type: training_page
permalink: "/trainings/nouvelle_tech/comprendre-les-différences-et-des-enjeux-de-la-AR/MR/VR/XR"
absolute_link: "http://learn.byseven.co/trainings/nouvelle-tech/comprendre-les-différences-et-des-enjeux-de-la-AR/MR/VR/XR"
title: "Comprendre les différences et des enjeux de  la AR/MR/VR/XR"
quote: "'C’est l’innovation qui différencie les leaders des suiveurs.' - Steve Jobs"
duration: "2 demi-journées"
location: "Paris"
price: "210€ HT"
image: "/assets/img/trainings/vr.jpg"
image_twitter: "/assets/img/trainings/vr.jpg"
order: 1
category: "TECH"
category_colour: "#55828b"
created_at: "23 Juillet 2021"
teaser: ""
custom_head: true
lang: fr
---
...
<div class="training-page-main">
  <div class="training-page-main-banner">
    <div class="training-page-main-banner-left">
      ...
      <p class="training-page-main-banner-left-description">Le marché de la VR est en pleine expansion et les analystes s’accordent à lui prédire un avenir radieux. Vous ne pouvez pas ignorer ses enjeux ainsi que son langage. Des nouveaux outils aux possibilités quasi infinies jusqu’à l’apparition de métiers inédits, on vous dit tout ce que vous devez savoir pour naviguer, vous approprier et devenir acteur de cette transformation !
      <br><br>
      Venez découvrir le fonctionnement de ces technologies par l’expérimentation avec des experts du domaine ! Vous construirez votre propre environnement 3D dans lequel inviter vos collaborateurs.
      </p>
    </div>
...
<div class="training-page-main-description">
  <div class="training-page-main-description-left" >
    ...
    <ul>
      <p style='margin-bottom: 0px;'>1. Introduction à l’eXtended Reality</p>
      <li>Découverte de la technologie, de ses enjeux et des métiers émergeants</li>
      <li>Expérimentation de l’Augmented Reality et de la Virtual Reality</li>
      <li>Réflexion sur les applications potentielles pour l’entreprise</li>
      <p style='margin-bottom: 0px;'>2. Conception d’un environnement 3D</p>
      <li>Découverte d’un outil de création de jeu 3D</li>
      <li>Conception du scénario de jeu</li>
      <li>Construction de l’environnement (à terminer pour la prochaine session si besoin)</li>
    </ul>
    <h5 style="color: {{page.category_colour}};">2 | SESSION 2</h5>
    <ul>
      <p style='margin-bottom: 0px;'>3. Programmation du jeu</p>
      <li>Introduction au codage Scratch</li>
      <li>Codage du jeu</li>
      <li>Test du jeu et correction de bugs</li>
      <li>Partage du jeu avec les autres collaborateurs</li>
    </ul>
  </div>
  <div class="training-page-main-description-right" >
    <div>
      ...
      <p>
      - Démystifier cette nouvelle technologie<br>
      - Comprendre ses enjeux et applications<br>
      - Maîtriser les bases de sont fonctionnement et le lexique associé<br>
      </p>
      ...
      <p>
       ...
       Des mises en situations et retours d'expériences pour s'approprier les concepts.Des mises en situations et retours d'expériences pour s'approprier les concepts
      </p>
