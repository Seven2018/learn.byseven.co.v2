...
title: "Augmenter sa réputation en ligne pour attirer plus de clients"
quote: "'Le personal branding, c’est ce que les gens disent de vous quand vous n’êtes plus dans la pièce.'– Jeff Bezos"
...
<div class="training-page-main">
  <div class="training-page-main-banner">
    <div class="training-page-main-banner-left">
      ...
      <p class="training-page-main-banner-left-description">Les participants à cette formation mettront en place les pour-actions permettant à court et moyen terme de maîtriser leur image et leur communication en construisant une marque engageante sur les plateformes de livraison.
      <br><br>
...
<div class="training-page-main-description">
  <div class="training-page-main-description-left" >
    ...
    <h6>C.ATTIRER DE NOUVEAUX CLIENTS</h6>
    <ul>
      <li>Atelier de travail collectif : construire son professional branding et la ligne éditoriale</li>
      <li>Atelier de travail collectif : augmenter sa réputation en ligne avec les outils technologiques le permettant</li>
    </ul>
  </div>
  <div class="training-page-main-description-right" >
    <div>
      ...
      <p>
      - Construire une marque restaurateur adaptée à la vente en livraison<br>
      - Savoir utiliser les leviers de notoriété pour élargir sa clientèle<br>
      </p>
